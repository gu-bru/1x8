(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1x8.loader.js";
    var config = {
        dataUrl: buildUrl + "/1x8.data",
        frameworkUrl: buildUrl + "/1x8.framework.js",
        codeUrl: buildUrl + "/1x8.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "G. Brunbauer",
        productName: "1x8 - Mathe mit Spass",
        productVersion: "2.6 vom  2.8.2023",
    };
